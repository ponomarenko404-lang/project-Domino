...
"Меблерія" Створи свій ідеальний дім.
...
1. Клонування репозиторію по посиланню вище прописати команду git clone
2. Встановлення залежностей npm install
3. Запуск у режимі розробки npm run dev
...
Це вебсайт для перегляду та вибору меблів. Користувач може ознайомитися з
асортиментом, переглянути деталі товарів і відгуки.

Проєкт вирішує задачу зручного представлення меблів онлайн та покращує
користувацький досвід при виборі товарів.
